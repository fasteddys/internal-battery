...
namespace WebApp_OpenIDConnect_DotNet.Controllers
{
    public class SessionController : Controller
    {
        ...
        {
            SetAzureAdB2CCulture();
            // Get the current culture and assign it to Azure options so the reset password screen will be localized 
        ...
        {
            SetAzureAdB2CCulture();
            // Get the current culture and assign it to Azure options so the edit profile  screen will be localized 
            var requestCulture = HttpContext.Features.Get<IRequestCultureFeature>();
            AzureAdB2COptions.UiLocales = requestCulture.RequestCulture.Culture.Name;
