...
{
    public class CommunityGroupSubscriberSearchResultDto
    {


        public int PageSize { get; set; }
        public int PageNum { get; set; }
        public int CommunityGroupSubscriberCount { get; set; }
        ...
        public List<SubscriberDto> CommunityGroupSubscribers { get; set; } = new List<SubscriberDto>();
    }
}
