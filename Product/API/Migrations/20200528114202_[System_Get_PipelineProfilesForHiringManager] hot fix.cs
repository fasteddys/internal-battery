...
{
    public partial class System_Get_PipelineProfilesForHiringManagerhotfix : Migration
    {
...
2020.05.28 - JAB - Fixed Bug with where on rnum not including profiles without title 
</remarks>
<description>
...
BEGIN
    WITH allRecords AS (
    	...
    	AND hm.IsDeleted = 0
		AND pp.IsDeleted = 0 
	    AND (swh_title.rnum = 1  or 	swh_title.rnum is null )		
