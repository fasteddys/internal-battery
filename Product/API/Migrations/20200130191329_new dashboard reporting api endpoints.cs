...
{
    public partial class newdashboardreportingapiendpoints : Migration
    {
...
*/
CREATE PROCEDURE [dbo].[System_Report_NewUsers]
AS
BEGIN
...
downloadable CSV file in the admin portal which contains detailed information for all users.
</description>
<example>
EXEC [dbo].[System_Report_AllUsersDetail]
</example>
*/
CREATE PROCEDURE [dbo].[System_Report_AllUsersDetail]
AS
BEGIN
...
*/
CREATE PROCEDURE [dbo].[System_Report_UsersByPartner](
    @StartDate DATETIME,
	@EndDate DATETIME
)
AS
...
*/
CREATE PROCEDURE [dbo].[System_Report_UsersByPartnerDetail](
