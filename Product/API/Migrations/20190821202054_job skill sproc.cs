...
{
    public partial class jobskillsproc : Migration
    {
...
/*
<remarks>
2018.08.21 - Bill Koenig - Created
</remarks>
<description>
...
EXEC [dbo].[System_Update_JobPostingSkills] @JobPostingId = 17980, @SkillGuids = @SkillGuids
</example>
*/
CREATE PROCEDURE [dbo].[System_Update_JobPostingSkills] (
	@JobPostingId INT,
...
DROP PROCEDURE [dbo].[System_Update_JobPostingSkills]
            ");
        }
    }
}
