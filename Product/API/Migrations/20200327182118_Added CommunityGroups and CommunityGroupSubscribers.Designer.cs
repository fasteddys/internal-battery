...
namespace UpDiddyApi.Migrations
{
    ...
    [Migration("20200327182118_Added CommunityGroups and CommunityGroupSubscribers")]
    partial class AddedCommunityGroupsandCommunityGroupSubscribers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UpDiddyApi.Models.CommunityGroup", b =>
                {
                    b.Property<int>("CommunityGroupId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<Guid?>("CommunityGroupGuid");
                    ...
                    b.HasKey("CommunityGroupId");

                    b.ToTable("CommunityGroup");
                });

            modelBuilder.Entity("UpDiddyApi.Models.CommunityGroupSubscriber", b =>
                {
                    b.Property<int>("CommunityGroupSubscriberId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("CommunityGroupId");

                    b.Property<int?>("CommunityGroupId1");

                    b.Property<Guid?>("CommunityGroupSubscriberGuid");
                    ...
                    b.Property<int?>("SubscriberId1");

                    b.HasKey("CommunityGroupSubscriberId");

                    b.HasIndex("CommunityGroupId");

                    b.HasIndex("CommunityGroupId1");

                    b.HasIndex("SubscriberId");

                    b.HasIndex("SubscriberId1");

                    b.ToTable("CommunityGroupSubscriber");
                });
            ...
            modelBuilder.Entity("UpDiddyApi.Models.CommunityGroupSubscriber", b =>
                {
                    b.HasOne("UpDiddyApi.Models.CommunityGroup")
                        .WithMany()
                        .HasForeignKey("CommunityGroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("UpDiddyApi.Models.CommunityGroup", "CommunityGroup")
                        .WithMany()
                        .HasForeignKey("CommunityGroupId1");
