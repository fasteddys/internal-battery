...
{
    public partial class g2profilecrud : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateIndex(
                name: "UIX_AzureIndexStatus_Name",
                schema: "G2",
...
*/
CREATE PROCEDURE [G2].[System_Create_Profile] (
...
*/
CREATE PROCEDURE [G2].[System_Update_Profile] (
...
BEGIN
    ...
    IF ((SELECT COUNT(1) FROM G2.Profiles WHERE ProfileGuid = @ProfileGuid) <> 1)
