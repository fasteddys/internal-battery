...
{
    public partial class Alterv_SubscriberSourcesview : Migration
    {
...
2019-08-15 - Bhupesh Vipparla - Alter query for SubscriberGroup, Group and Partner
</remarks>
<description>
...
Inner join Partner p on g.PartnerId=p.PartnerId
where sg.IsDeleted=0 and g.IsDeleted=0 and p.IsDeleted=0
