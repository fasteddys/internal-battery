...
{
    public partial class FixforSystem_Get_JobCrudBySubscriber : Migration
    {
 ...
 /*
<remarks>
2020.01.13 - JAB - Created 
2020.01.21 - JAB - Corrected bug with logic for getting total record count 
...
*/
ALTER PROCEDURE [dbo].[System_Get_JobCrudBySubscriber] (
...
BEGIN 
	WITH allRecords AS (
		...
		where s.SubscriberGuid = @SubscrberGuid and  jp.IsDeleted = 0
