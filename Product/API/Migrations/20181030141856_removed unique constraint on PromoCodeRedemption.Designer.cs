...
namespace UpDiddyApi.Migrations
{
    ...
    [Migration("20181030141856_removed unique constraint on PromoCodeRedemption")]
    partial class removeduniqueconstraintonPromoCodeRedemption
    {
            ...
            modelBuilder.Entity("UpDiddyApi.Models.PromoType", b =>
                {
                    ...
                    b.HasData(
                        new { PromoTypeId = 1, CreateDate = new DateTime(2018, 10, 30, 10, 18, 55, 719, DateTimeKind.Local), CreateGuid = new Guid("1e44d748-b4a6-4639-8e68-06351765470b"), Description = "This type indicates that the PromoValueFactor is the dollar amount that should be subtracted from the course cost.", IsDeleted = 0, Name = "Dollar Amount", PromoTypeGuid = new Guid("91fd720b-34f2-4b4e-8b4c-34bfc0f9b41e") },
                        new { PromoTypeId = 2, CreateDate = new DateTime(2018, 10, 30, 10, 18, 55, 719, DateTimeKind.Local), CreateGuid = new Guid("d7422d91-4446-45f3-9212-794fb95ae8a8"), Description = "This type indicates that the the course cost should be reduced by the percentage value of the PromoValueFactor.", IsDeleted = 0, Name = "Percent Off", PromoTypeGuid = new Guid("719ec7a9-16f4-4542-9ec8-b0fbfdd506be") }
                    );
                });
            ...
            modelBuilder.Entity("UpDiddyApi.Models.RedemptionStatus", b =>
                {
                    ...
                    b.HasData(
                        new { RedemptionStatusId = 1, CreateDate = new DateTime(2018, 10, 30, 10, 18, 55, 717, DateTimeKind.Local), CreateGuid = new Guid("ce5ffd75-5c3c-46a5-9c4b-75de5098754a"), IsDeleted = 0, Name = "In Process", RedemptionStatusGuid = new Guid("0ad0d97f-6c07-48e8-b9cf-4416c5d92579") },
                        new { RedemptionStatusId = 2, CreateDate = new DateTime(2018, 10, 30, 10, 18, 55, 717, DateTimeKind.Local), CreateGuid = new Guid("f787bfc9-297a-44ae-911d-4b5c98a49e26"), IsDeleted = 0, Name = "Completed", RedemptionStatusGuid = new Guid("cd7effab-2d28-4ca9-9707-397f807f1a9d") }
                    );
                });
