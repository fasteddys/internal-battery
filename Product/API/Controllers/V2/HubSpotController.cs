...
namespace UpDiddyApi.Controllers.V2
{
    ...
    public class HubSpotController : Controller
    {
        ...
        public async Task<IActionResult> test([FromBody] HubSpotContactDto contactDto)
        {
           ...
           long vid = await  _hubSpotService.AddOrUpdateContactBySubscriberGuid(Guid.Parse("CE5F121A-C129-4BE5-B005-EEEB48339677"),lastLoginDateTime: null, nonBlocking: false);
