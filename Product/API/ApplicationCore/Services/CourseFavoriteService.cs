...
namespace UpDiddyApi.ApplicationCore.Services
{
    public class CourseFavoriteService : ICourseFavoriteService
    {
        ...
        public async Task<List<CourseFavoriteDto>> GetFavoriteCourses(Guid subscriberGuid, int limit = 10, int offset = 0, string sort = "modifyDate", string order = "descending")
        {
