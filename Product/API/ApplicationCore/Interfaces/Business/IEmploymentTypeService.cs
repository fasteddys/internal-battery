...
namespace UpDiddyApi.ApplicationCore.Interfaces.Business
{
    public interface IEmploymentTypeService
    {
        ...
        Task<List<EmploymentTypeDto>> GetEmploymentTypes(int limit = 10, int offset = 0, string sort = "modifyDate", string order = "descending");
        Task UpdateEmploymentType(Guid employmentTypeGuid, EmploymentTypeDto employmentTypeDto);
        Task CreateEmploymentType(EmploymentTypeDto employmentTypeDto);
