            ...
            foreach (var jobPage in pendingJobPages)
            {
                try
                {
                    ...
                    if (jobPage.JobPostingId.HasValue)
                    {
                        ...
                        isJobPostingOperationSuccessful = JobPostingFactory.UpdateJobPosting(_db, jobPostingGuid, jobPostingDto, ref errorMessage, _hangfireService);
                    ...
                    else
                    {
                        ...
                        isJobPostingOperationSuccessful = JobPostingFactory.PostJob(_db, recruiter.RecruiterId, jobPostingDto, ref jobPostingGuid, ref errorMessage, _syslog, _mapper, _configuration, _hangfireService);
