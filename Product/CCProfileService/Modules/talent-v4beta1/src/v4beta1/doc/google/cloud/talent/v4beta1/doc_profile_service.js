 ...
 *      algorithms.
 *   * "update_time desc": Sort by Profile.update_time in descending order
 *     (recently updated profiles first).
 *   * "create_time desc": Sort by Profile.create_time in descending order
 ...
 *   for example, "projects/api-test-project/tenants/foo/profiles/bar".
 *
 * @property {Object} touchMask
 *   Optional.
 *
 *   The fields on the profile which have been reviewed. If this touch_mask is
 *   not provided, all fields in Profile are regarded as touched.
 *
 *   This object should have the same structure as [FieldMask]{@link google.protobuf.FieldMask}
 *
 * @property {Object} fieldUpdateMetadata
 *   Optional.
 *
 *   The profile update history for these reviewed fields. If this argument is
 ...
 *
 *   This object should have the same structure as [FieldUpdateMetadata]{@link google.cloud.talent.v4beta1.FieldUpdateMetadata}
 *
 * @typedef TouchProfileRequest
 * @memberof google.cloud.talent.v4beta1
 * @see [google.cloud.talent.v4beta1.TouchProfileRequest definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/profile_service.proto}
 */
const TouchProfileRequest = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};
 ...
 *   Required.
 *
 *   The tags to which this profile is assigned.
 *
 * @typedef AddProfileTagsRequest
 * @memberof google.cloud.talent.v4beta1
 * @see [google.cloud.talent.v4beta1.AddProfileTagsRequest definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/profile_service.proto}
 */
const AddProfileTagsRequest = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};
 ...
 *   Required.
 *
 *   The tags from which this profile is removed.
 *
 * @typedef RemoveProfileTagsRequest
 * @memberof google.cloud.talent.v4beta1
 * @see [google.cloud.talent.v4beta1.RemoveProfileTagsRequest definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/profile_service.proto}
 */
const RemoveProfileTagsRequest = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};