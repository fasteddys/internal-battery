 ...
 *   The maximum number of allowed characters is 500.
 *
 * @property {Object[]} structuredAddresses
 *   Optional.
 *
 *   Structured location(s) where the job is hiring.  Providing the full street
 ...
 *
 * @property {Object[]} jobRequirements
 *   Optional.
 *
 ...
 *   DeleteJob and ListJobs APIs,
 *   but it can be retrieved with the GetJob API or
 *   updated with the UpdateJob API. An expired job can
