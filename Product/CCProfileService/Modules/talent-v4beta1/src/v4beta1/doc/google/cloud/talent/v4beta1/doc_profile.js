 ...
 *
 * @property {boolean} currentlyPlaced
 ...
 *   APPLY_INDIRECT).
 *
 * @property {boolean} previouslyPlaced
 ...
 *   IN_PROGRESS)
 *
 * @property {Object[]} summarizedEmploymentHistory
 ...
 *   order by end_date.
 *
 *   This object should have the same structure as [EmploymentRecordSummary]{@link google.cloud.talent.v4beta1.EmploymentRecordSummary}
 *
 ...
 *
 *   This object should have the same structure as [Availability]{@link google.cloud.talent.v4beta1.Availability}
 *
 * @property {boolean} negativeFeedback
 *   Output only.
 *   Reflects "true" if:
 ...
 *   Output only. Candidate's overall availability based on signals.
 *
 * @property {Object} jobApplicationAvailabilitySignal
 ...
 *   "false".
 *
 *   This object should have the same structure as [JobApplicationAvailabilitySignal]{@link google.cloud.talent.v4beta1.JobApplicationAvailabilitySignal}
 *
 * @property {Object} profileUpdateAvailabilitySignal
 ...
 *   to "false".
 *
 *   This object should have the same structure as [ProfileUpdateAvailabilitySignal]{@link google.cloud.talent.v4beta1.ProfileUpdateAvailabilitySignal}
 *
 * @typedef Availability
 * @memberof google.cloud.talent.v4beta1
 * @see [google.cloud.talent.v4beta1.Availability definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/profile.proto}
 */
const Availability = {
  // This is for documentation. Actual contents will be loaded by gRPC.
   ...
   *
   * @typedef JobApplicationAvailabilitySignal
   * @memberof google.cloud.talent.v4beta1
   * @see [google.cloud.talent.v4beta1.Availability.JobApplicationAvailabilitySignal definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/profile.proto}
   */
   ...
   *
   * @typedef ProfileUpdateAvailabilitySignal
   * @memberof google.cloud.talent.v4beta1
   * @see [google.cloud.talent.v4beta1.Availability.ProfileUpdateAvailabilitySignal definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/profile.proto}
   */
 ...
 *   found.
 *
 *   The number should be among the values of [EmploymentRecordSummarySource]{@link google.cloud.talent.v4beta1.EmploymentRecordSummarySource}
 *
 * @typedef EmploymentRecordSummary
 * @memberof google.cloud.talent.v4beta1
 * @see [google.cloud.talent.v4beta1.EmploymentRecordSummary definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/profile.proto}
 */
const EmploymentRecordSummary = {
  // This is for documentation. Actual contents will be loaded by gRPC.
