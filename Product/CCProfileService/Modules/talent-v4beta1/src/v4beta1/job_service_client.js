...
class JobServiceClient {
  ...
  constructor(opts) {
    ...
    protoFilesRoot = protobuf.loadSync(
      path.join(__dirname, '..', '..', 'protos', 'google/cloud/talent/v4beta1/job_service.proto'),
      protoFilesRoot
    );
   ...
   *     JobQuery.location_filters must not be empty. When
   *     a job has multiple locations, the location closest to one of the
   *     locations specified in the location filter will be used to calculate
   ...
   *   top level fields of Job are supported.
   *
   *   If update_mask is provided, The Job inside JobResult
