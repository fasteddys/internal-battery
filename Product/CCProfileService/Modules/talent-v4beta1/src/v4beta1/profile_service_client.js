...
class ProfileServiceClient {
  ...
  /**
   * Mark certain fields as having been recently reviewed.
   *
   ...
   *   "projects/{project_id}/tenants/{tenant_id}/profiles/{profile_id}",
   *   for example, "projects/api-test-project/tenants/foo/profiles/bar".
   * @param {Object} [request.touchMask]
   *   Optional.
   *
   ...
   *
   *   This object should have the same structure as [FieldMask]{@link google.protobuf.FieldMask}
   * @param {Object} [request.fieldUpdateMetadata]
   *   Optional.
   *
   ...
   *
   * const formattedName = client.profilePath('[PROJECT]', '[TENANT]', '[PROFILE]');
   * client.touchProfile({name: formattedName})
   *   .then(responses => {
   *     const response = responses[0];
   *     // doThingsWith(response)
   *   })
   ...
   *   });
   */
  touchProfile(request, options, callback) {
    if (options instanceof Function && callback === undefined) {
      callback = options;
      options = {};
    }
    ...
    return this._innerApiCalls.touchProfile(request, options, callback);
  }

  /**
   * Add tags into a profile.
   *
   * @param {Object} request
   *   The request object that will be sent.
   ...
   * });
   *
   * const formattedProfile = client.profilePath('[PROJECT]', '[TENANT]', '[PROFILE]');
   * const tags = [];
   * const request = {
   *   profile: formattedProfile,
   *   tags: tags,
   * };
   * client.addProfileTags(request)
   *   .then(responses => {
   *     const response = responses[0];
   *     // doThingsWith(response)
   *   })
   ...
   *   });
   */
  addProfileTags(request, options, callback) {
    if (options instanceof Function && callback === undefined) {
      callback = options;
      options = {};
    }
    ...
    return this._innerApiCalls.addProfileTags(request, options, callback);
  }
   ...
   *   tags: tags,
   * };
   * client.removeProfileTags(request)
   *   .then(responses => {
   *     const response = responses[0];
   *     // doThingsWith(response)
   *   })
   ...
   *   });
   */
  removeProfileTags(request, options, callback) {
    if (options instanceof Function && callback === undefined) {
      callback = options;
      options = {};
    }
    ...
    return this._innerApiCalls.removeProfileTags(request, options, callback);
  }
