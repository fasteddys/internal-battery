 ...
 *   Optional.
 *
 *   A map of fields to hold both filterable and non-filterable custom company
 ...
 *   is 50KB.
 *
 * @property {string} dunsId
 *   Optional.
 *
 *   The [DUNS](http://go/wiki/Data_Universal_Numbering_System) unique
 *   identifier of the company.
 *
 * @property {string} languageCode
 *   Optional.
 *
 *   The BCP-47 language code for the language in which this company meta-data
 ...
 *   Optional.
 *
 *   NAICS codes of the company. For more information, see [North American
