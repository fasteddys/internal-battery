 ...
 *   One of recruiter and profile is required.
 *
 *   This is a unique identifier of the recruiter who triggered the event.
 *   (This is required to support filtering by individual recruiter behavior.)
 *
 * @property {string} profile
 *   One of recruiter and profile is required.
 *
 *   This is a unique identifier of the candidate who triggered the event.
 *   (This is required to support the candidate availability user stories)
 *
...
const ProfileEvent = {
  ...
  ProfileEventType: {
    ...
    /**
     * The profile is marked as not show.
     */
    MARKED_AS_NOT_SHOW: 12,

    /**
     * Recruiter called or attempted to call the profile
     * (regardless of if the candidate was reached).
     */
    CONTACT_PHONE: 13,
