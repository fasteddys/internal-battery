...
class RecruiterServiceClient {
   ...
   *
   *
   * client.deleteRecruiter({}).catch(err => {
   *   console.error(err);
   * });
   */
   ...
   *
   *
   * client.addRecruiterProfileTags({})
   *   .then(responses => {
   *     const response = responses[0];
   *     // doThingsWith(response)
   *   })
   ...
   *
   *
   * client.removeRecruiterProfileTags({})
   *   .then(responses => {
   *     const response = responses[0];
   *     // doThingsWith(response)
   *   })
