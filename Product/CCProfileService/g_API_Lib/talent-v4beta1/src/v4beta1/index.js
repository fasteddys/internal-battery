...
const AssignmentServiceClient = require('./assignment_service_client');
...
const RecommendationServiceClient = require('./recommendation_service_client');
const RecruiterServiceClient = require('./recruiter_service_client');
const TenantServiceClient = require('./tenant_service_client');

module.exports.ApplicationServiceClient = ApplicationServiceClient;
module.exports.AssignmentServiceClient = AssignmentServiceClient;
...
module.exports.RecommendationServiceClient = RecommendationServiceClient;
module.exports.RecruiterServiceClient = RecruiterServiceClient;
